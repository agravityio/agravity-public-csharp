...
namespace Agravity.Public.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "11.1.0-1757.2";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/11.1.0-1757.2/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 11.1.0-1757.2\n";
            report += "    SDK Package Version: 11.1.0-1757.2\n";
