...
{
    /// <summary>
    ///  Class for testing PublicSignalRConnectionManagementApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class PublicSignalRConnectionManagementApiTests : IDisposable
    {
        private PublicSignalRConnectionManagementApi instance;

        public PublicSignalRConnectionManagementApiTests()
        {
            instance = new PublicSignalRConnectionManagementApi();
        }
        ...
        /// <summary>
        /// Test an instance of PublicSignalRConnectionManagementApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' PublicSignalRConnectionManagementApi
            //Assert.IsType<PublicSignalRConnectionManagementApi>(instance);
        }

        /// <summary>
        /// Test HttpSignalRNegotiate
        /// </summary>
        [Fact]
        public void HttpSignalRNegotiateTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.HttpSignalRNegotiate();
            //Assert.IsType<SignalRConnectionInfo>(response);
        }
    }
}
