...
namespace Agravity.Public.Model
{
    ...
    public partial class Portal : IValidatableObject
    {
        ...
        public Portal(string id = default, string entityType = default, PortalAuthentication authentication = default, string languages = default, List<PortalFields> fields = default, string filter = default, List<string> limitIds = default, List<SharedAllowedFormat> allowedFormats = default, List<AssetIconRule> assetIconRules = default, List<string> allowedOrigins = default, PortalLinks links = default, PortalTheme theme = default, string name = default, string description = default, Dictionary<string, object> addProperties = default, string status = default, DateTime? createdDate = default, string createdBy = default, DateTime? modifiedDate = default, string modifiedBy = default, string pk = default, string etag = default)
        {
            this.Id = id;
