...
namespace Agravity.Public.Model
{
    ...
    /// EntityIdName
    /// </summary>
    [DataContract(Name = "entityIdName")]
    public partial class EntityIdName : IValidatableObject
    {
        /// <summary>
        ...
        public EntityIdName(string name = default, string entityType = default, string status = default, Dictionary<string, Dictionary<string, object>> translations = default, string id = default, string pk = default)
        {
            this.Name = name;
