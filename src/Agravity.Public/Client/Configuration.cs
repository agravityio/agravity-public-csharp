...
namespace Agravity.Public.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "11.0.3";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/11.0.3/csharp");
        ...
        public Configuration(
            ...
            string basePath = "http://localhost:7072/api") : this()
        {
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 11.0.3\n";
            report += "    SDK Package Version: 11.0.3\n";
