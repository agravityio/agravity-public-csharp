...
namespace Agravity.Public.Model
{
    ...
    /// </summary>
    [DataContract(Name = "agravityUserOnlineStatus")]
    public partial class AgravityUserOnlineStatus : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AgravityUserOnlineStatus" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        /// <param name="lastConnection">lastConnection.</param>
        public AgravityUserOnlineStatus(string status = default, DateTime? lastConnection = default)
        {
            this.Status = status;
        ...
        /// </summary>
        [DataMember(Name = "last_connection", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AgravityUserOnlineStatus {\n");
