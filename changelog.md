...
- #1758 Add POST /search -  This endpoint returns a configured max amount of results for search options in the request body.
...
## AgravityAPI <a name="11.0.4"/> [11.0.4](https://www.nuget.org/packages/Agravity.Public/11.0.4) (2026-06-26)

- Just version upgrade to match backend

## AgravityAPI <a name="11.0.3"/> [11.0.3](https://www.nuget.org/packages/Agravity.Public/11.0.3) (2026-06-25)

- Just version upgrade to match backend

## AgravityAPI <a name="11.0.2"/> [11.0.2](https://www.nuget.org/packages/Agravity.Public/11.0.2) (2026-06-03)

- Just version upgrade to match backend

## AgravityAPI <a name="11.0.1"/> [11.0.1](https://www.nuget.org/packages/Agravity.Public/11.0.1) (2026-05-24)

- Just version upgrade to match backend

## AgravityAPI <a name="11.0.0"/> [11.0.0](https://www.nuget.org/packages/Agravity.Public/11.0.0) (2026-05-17)

- .NET10 upgrade (OpenAPI Generator 7.20.0)

## AgravityAPI <a name="10.3.5"/> [10.3.5](https://www.nuget.org/packages/Agravity.Public/10.3.5) (2026-05-03)

- Just version upgrade to match backend

## AgravityAPI <a name="10.3.4"/> [10.3.4](https://www.nuget.org/packages/Agravity.Public/10.3.4) (2026-04-13)
...
- Generate with new openAPI Generator 9.15.0
  - Remove generation of .net6.0 compatible code
  - Add support of .net9.0 (in project)
...
## AgravityAPI <a name="9.1.1"/> [9.1.1](https://www.nuget.org/packages/Agravity.Public/9.1.1) (2025-06-10)
