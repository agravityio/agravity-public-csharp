...
namespace AgravityPublic.Test
{
    ...
    /// </remarks>
    public class PublicCollectionSharingApiTests
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOf' PublicCollectionSharingApi
            //Assert.IsInstanceOf(typeof(PublicCollectionSharingApi), instance);
        }
        ...
        public void HttpSharedCollectionsGetByIdTest()
        {
            ...
            //Assert.IsInstanceOf(typeof(SharedCollectionFull), response, "response is SharedCollectionFull");
        }
