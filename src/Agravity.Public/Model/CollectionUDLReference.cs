...
namespace Agravity.Public.Model
{
    ...
    /// </summary>
    [DataContract(Name = "collectionUDLReference")]
    public partial class CollectionUDLReference : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectionUDLReference" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets CollTypes
        /// </summary>
        [DataMember(Name = "coll_types", EmitDefaultValue = true)]
        public List<string> CollTypes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectionUDLReference {\n");
            sb.Append("  Parent: ").Append(Parent).Append("\n");
            sb.Append("  CollTypes: ").Append(CollTypes).Append("\n");
