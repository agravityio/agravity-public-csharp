...
namespace Agravity.Public.Model
{
    ...
    /// AssetBulkUpdate
    /// </summary>
    [DataContract(Name = "assetBulkUpdate")]
    public partial class AssetBulkUpdate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetBulkUpdate" /> class.
        /// </summary>
        /// <param name="collectionId">collectionId.</param>
        /// <param name="refAsset">refAsset.</param>
        /// <param name="assetIds">assetIds.</param>
        public AssetBulkUpdate(string collectionId = default, Asset refAsset = default, List<string> assetIds = default)
        {
        ...
        /// <summary>
        /// Gets or Sets RefAsset
        /// </summary>
        [DataMember(Name = "ref_asset", EmitDefaultValue = false)]
        public Asset RefAsset { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetBulkUpdate {\n");
            sb.Append("  CollectionId: ").Append(CollectionId).Append("\n");
            sb.Append("  RefAsset: ").Append(RefAsset).Append("\n");
