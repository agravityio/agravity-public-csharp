...
namespace Agravity.Public.Test.Model
{
    ...
    public class CollectionUDLTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" CollectionUDL
            //Assert.IsType<CollectionUDL>(instance);
        }
