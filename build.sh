...
${nuget_cmd} install src/AgravityPublic/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/AgravityPublic.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/AgravityPublic.dll \
-recurse:'src/AgravityPublic/*.cs' \
-doc:bin/AgravityPublic.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/AgravityPublic.dll was created successfully"
fi
