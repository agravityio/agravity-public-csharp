...
namespace Agravity.Public.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "10.3.2";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/10.3.2/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 10.3.2\n";
            report += "    SDK Package Version: 10.3.2\n";
