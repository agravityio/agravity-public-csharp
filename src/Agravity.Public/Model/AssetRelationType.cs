...
namespace Agravity.Public.Model
{
    ...
    /// AssetRelationType
    /// </summary>
    [DataContract(Name = "assetRelationType")]
    public partial class AssetRelationType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetRelationType" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="entityType">entityType.</param>
        /// <param name="hierarchical">hierarchical.</param>
        /// <param name="sequential">sequential.</param>
        /// <param name="uniquePerAsset">uniquePerAsset.</param>
        ...
        public AssetRelationType(string id = default, string entityType = default, bool? hierarchical = default, bool? sequential = default, bool? uniquePerAsset = default, Dictionary<string, Dictionary<string, object>> translations = default, List<PermissionEntity> permissions = default, string name = default, string description = default, Dictionary<string, object> addProperties = default, string status = default, DateTime? createdDate = default, string createdBy = default, DateTime? modifiedDate = default, string modifiedBy = default, string pk = default, string etag = default)
        {
            this.Id = id;
            this.EntityType = entityType;
            this.Hierarchical = hierarchical;
            this.Sequential = sequential;
            this.UniquePerAsset = uniquePerAsset;
        ...
        /// <summary>
        /// Gets or Sets Hierarchical
        /// </summary>
        [DataMember(Name = "hierarchical", EmitDefaultValue = true)]
        public bool? Hierarchical { get; set; }

        /// <summary>
        /// Gets or Sets Sequential
        /// </summary>
        [DataMember(Name = "sequential", EmitDefaultValue = true)]
        public bool? Sequential { get; set; }

        /// <summary>
        /// Gets or Sets UniquePerAsset
        /// </summary>
        [DataMember(Name = "unique_per_asset", EmitDefaultValue = true)]
        public bool? UniquePerAsset { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetRelationType {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EntityType: ").Append(EntityType).Append("\n");
            sb.Append("  Hierarchical: ").Append(Hierarchical).Append("\n");
            sb.Append("  Sequential: ").Append(Sequential).Append("\n");
            sb.Append("  UniquePerAsset: ").Append(UniquePerAsset).Append("\n");
