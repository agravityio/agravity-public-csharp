...
namespace Agravity.Public.Model
{
    ...
    public partial class EntityIdName : IEquatable<EntityIdName>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as EntityIdName);
        }

        /// <summary>
        /// Returns true if EntityIdName instances are equal
        /// </summary>
        /// <param name="input">Instance of EntityIdName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntityIdName input)
        {
            if (input == null)
            {
                return false;
