...
{
    /// <summary>
    ///  Class for testing PublicAssetRelationTypeManagementApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class PublicAssetRelationTypeManagementApiTests : IDisposable
    {
        private PublicAssetRelationTypeManagementApi instance;

        public PublicAssetRelationTypeManagementApiTests()
        {
            instance = new PublicAssetRelationTypeManagementApi();
        }
        ...
        /// <summary>
        /// Test an instance of PublicAssetRelationTypeManagementApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' PublicAssetRelationTypeManagementApi
            //Assert.IsType<PublicAssetRelationTypeManagementApi>(instance);
        }

        /// <summary>
        /// Test HttpAssetRelationTypeGetAll
        /// </summary>
        [Fact]
        public void HttpAssetRelationTypeGetAllTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //bool? translations = null;
            //string acceptLanguage = null;
            //var response = instance.HttpAssetRelationTypeGetAll(translations, acceptLanguage);
            //Assert.IsType<List<AssetRelationType>>(response);
        }

        /// <summary>
        /// Test HttpAssetRelationTypeGetById
        /// </summary>
        [Fact]
        public void HttpAssetRelationTypeGetByIdTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //bool? translations = null;
            //string acceptLanguage = null;
            //var response = instance.HttpAssetRelationTypeGetById(id, translations, acceptLanguage);
            //Assert.IsType<AssetRelationType>(response);
        }
    }
}
