...
namespace AgravityPublic.Test
{
    ...
    /// </remarks>
    public class PublicCollectionSecureUploadApiTests
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOf' PublicCollectionSecureUploadApi
            //Assert.IsInstanceOf(typeof(PublicCollectionSecureUploadApi), instance);
        }
        ...
        public void HttpSecureUploadEntityCheckByIdTest()
        {
            ...
            //Assert.IsInstanceOf(typeof(SecureUploadEntity), response, "response is SecureUploadEntity");
        }
