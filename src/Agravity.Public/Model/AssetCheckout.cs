...
namespace Agravity.Public.Model
{
    ...
    /// AssetCheckout
    /// </summary>
    [DataContract(Name = "assetCheckout")]
    public partial class AssetCheckout : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetCheckout" /> class.
        /// </summary>
        /// <param name="userId">userId.</param>
        /// <param name="checkoutDate">checkoutDate.</param>
        public AssetCheckout(string userId = default, DateTime? checkoutDate = default)
        {
            this.UserId = userId;
        ...
        /// </summary>
        [DataMember(Name = "checkout_date", EmitDefaultValue = true)]
