...
namespace AgravityPublic.Api
{
    ...
    /// </summary>
    public interface IPublicWorkspaceManagementApi : IApiAccessor
    {
        ...
        ApiResponse<Workspace> HttpWorkspacesGetByIdWithHttpInfo (string id);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Workspace>>> HttpWorkspacesGetWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Workspace> HttpWorkspacesGetByIdAsync (string id, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Workspace>> HttpWorkspacesGetByIdWithHttpInfoAsync (string id, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class PublicWorkspaceManagementApi : IPublicWorkspaceManagementApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public PublicWorkspaceManagementApi()
        {
        ...
        /// <returns></returns>
        public PublicWorkspaceManagementApi(AgravityPublic.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<List<Workspace>> HttpWorkspacesGetWithHttpInfo ()
        {
            ...
            {
                Exception exception = ExceptionFactory("HttpWorkspacesGet", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (List&lt;Workspace&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<Workspace>>> HttpWorkspacesGetWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="id">The ID of the workspace.</param>
        /// <returns>Workspace</returns>
        public Workspace HttpWorkspacesGetById (string id)
        {
             ApiResponse<Workspace> localVarResponse = HttpWorkspacesGetByIdWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">The ID of the workspace.</param>
        /// <returns>ApiResponse of Workspace</returns>
        public ApiResponse<Workspace> HttpWorkspacesGetByIdWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling PublicWorkspaceManagementApi->HttpWorkspacesGetById");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("HttpWorkspacesGetById", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Workspace</returns>
        public async System.Threading.Tasks.Task<Workspace> HttpWorkspacesGetByIdAsync (string id, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Workspace> localVarResponse = await HttpWorkspacesGetByIdWithHttpInfoAsync(id, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Workspace)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Workspace>> HttpWorkspacesGetByIdWithHttpInfoAsync (string id, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling PublicWorkspaceManagementApi->HttpWorkspacesGetById");
