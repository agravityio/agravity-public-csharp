...
namespace Agravity.Public.Test.Api
{
    ...
    /// </remarks>
    public class PublicConfigurationManagementApiTests : IDisposable
    {
        private PublicConfigurationManagementApi instance;

        public PublicConfigurationManagementApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' PublicConfigurationManagementApi
            //Assert.IsType<PublicConfigurationManagementApi>(instance);
        }
