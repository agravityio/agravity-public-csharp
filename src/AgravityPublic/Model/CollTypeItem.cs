...
namespace AgravityPublic.Model
{
    ...
    public partial class CollTypeItem :  IEquatable<CollTypeItem>, IValidatableObject
    {
        ...
        public CollTypeItem(string id = default(string), string entityType = default(string), string name = default(string), string itemType = default(string), string label = default(string), Object defaultValue = default(Object), bool? mandatory = default(bool?), bool? searchable = default(bool?), bool? onlyasset = default(bool?), bool? multi = default(bool?), string md5 = default(string), string group = default(string), int? order = default(int?), Dictionary<string, Dictionary> translations = default(Dictionary<string, Dictionary>), string status = default(string), DateTime? createdDate = default(DateTime?), string createdBy = default(string), DateTime? modifiedDate = default(DateTime?), string modifiedBy = default(string), string pk = default(string), string etag = default(string))
        {
