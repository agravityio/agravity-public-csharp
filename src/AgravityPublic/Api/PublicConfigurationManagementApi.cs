...
namespace AgravityPublic.Api
{
    ...
    /// </summary>
    public interface IPublicConfigurationManagementApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<List<FrontendAppConfig>>> HttpConfigGetFrontendAllWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class PublicConfigurationManagementApi : IPublicConfigurationManagementApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public PublicConfigurationManagementApi()
        {
        ...
        /// <returns></returns>
        public PublicConfigurationManagementApi(AgravityPublic.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<List<FrontendAppConfig>> HttpConfigGetFrontendAllWithHttpInfo ()
        {
            ...
            var localVarPath = "/config/frontend";
            ...
            {
                Exception exception = ExceptionFactory("HttpConfigGetFrontendAll", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<List<FrontendAppConfig>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (List<FrontendAppConfig>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<FrontendAppConfig>)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (List&lt;FrontendAppConfig&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<FrontendAppConfig>>> HttpConfigGetFrontendAllWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
