...
namespace AgravityPublic.Model
{
    ...
    public partial class PublishedAsset :  IEquatable<PublishedAsset>, IValidatableObject
    {
        ...
        public PublishedAsset(string id = default(string), string name = default(string), string description = default(string), List<string> usecases = default(List<string>), DateTime createdDate = default(DateTime), string url = default(string), string cdn = default(string), bool original = default(bool), Dictionary<string, Object> properties = default(Dictionary<string, Object>))
        {
            this.Id = id;
            this.Name = name;
