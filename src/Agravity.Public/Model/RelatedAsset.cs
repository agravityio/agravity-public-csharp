...
namespace Agravity.Public.Model
{
    ...
    /// RelatedAsset
    /// </summary>
    [DataContract(Name = "relatedAsset")]
    public partial class RelatedAsset : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RelatedAsset" /> class.
        /// </summary>
