...
${nuget_cmd} install src/Agravity.Public/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Agravity.Public.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Agravity.Public.dll \
-recurse:'src/Agravity.Public/*.cs' \
-doc:bin/Agravity.Public.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Agravity.Public.dll was created successfully"
fi
