...
namespace Agravity.Public.Api
{
    ...
    public interface IPublicCollectionManagementApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task HttpPublicCollectionsDeleteByIdAsync(string id, bool? deleteassets = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> HttpPublicCollectionsDeleteByIdWithHttpInfoAsync(string id, bool? deleteassets = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class PublicCollectionManagementApi : IPublicCollectionManagementApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task HttpPublicCollectionsDeleteByIdAsync(string id, bool? deleteassets = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Agravity.Public.Client.ApiResponse<Object>> HttpPublicCollectionsDeleteByIdWithHttpInfoAsync(string id, bool? deleteassets = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
