...
namespace Agravity.Public.Api
{
    ...
    public interface IPublicWebAppDataApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<GroupAllAppData> HttpGetDataCollectionTypeAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<GroupAllAppData>> HttpGetDataCollectionTypeWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<AllWebAppData> HttpGetWebAppDataAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<AllWebAppData>> HttpGetWebAppDataWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class PublicWebAppDataApi : IPublicWebAppDataApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GroupAllAppData</returns>
        public async System.Threading.Tasks.Task<GroupAllAppData> HttpGetDataCollectionTypeAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GroupAllAppData)</returns>
        public async System.Threading.Tasks.Task<Agravity.Public.Client.ApiResponse<GroupAllAppData>> HttpGetDataCollectionTypeWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AllWebAppData</returns>
        public async System.Threading.Tasks.Task<AllWebAppData> HttpGetWebAppDataAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AllWebAppData)</returns>
        public async System.Threading.Tasks.Task<Agravity.Public.Client.ApiResponse<AllWebAppData>> HttpGetWebAppDataWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
