...
namespace AgravityPublic.Api
{
    ...
    public interface IPublicStaticDefinedListManagementApi : IApiAccessor
    {
        ...
        ApiResponse<StaticDefinedList> HttpStaticDefinedListsGetByIdWithHttpInfo (string id);
        ...
        System.Threading.Tasks.Task<StaticDefinedList> HttpStaticDefinedListsGetByIdAsync (string id, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<StaticDefinedList>> HttpStaticDefinedListsGetByIdWithHttpInfoAsync (string id, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class PublicStaticDefinedListManagementApi : IPublicStaticDefinedListManagementApi
    {
        ...
        /// <param name="id">The ID of the static defined list.</param>
        /// <returns>StaticDefinedList</returns>
        public StaticDefinedList HttpStaticDefinedListsGetById (string id)
        {
             ApiResponse<StaticDefinedList> localVarResponse = HttpStaticDefinedListsGetByIdWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">The ID of the static defined list.</param>
        /// <returns>ApiResponse of StaticDefinedList</returns>
        public ApiResponse<StaticDefinedList> HttpStaticDefinedListsGetByIdWithHttpInfo (string id)
        {
            ...
            return new ApiResponse<StaticDefinedList>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (StaticDefinedList) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(StaticDefinedList)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of StaticDefinedList</returns>
        public async System.Threading.Tasks.Task<StaticDefinedList> HttpStaticDefinedListsGetByIdAsync (string id, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<StaticDefinedList> localVarResponse = await HttpStaticDefinedListsGetByIdWithHttpInfoAsync(id, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (StaticDefinedList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<StaticDefinedList>> HttpStaticDefinedListsGetByIdWithHttpInfoAsync (string id, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling PublicStaticDefinedListManagementApi->HttpStaticDefinedListsGetById");
