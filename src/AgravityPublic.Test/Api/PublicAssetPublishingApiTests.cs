...
namespace AgravityPublic.Test
{
    ...
    /// </remarks>
    public class PublicAssetPublishingApiTests
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOf' PublicAssetPublishingApi
            //Assert.IsInstanceOf(typeof(PublicAssetPublishingApi), instance);
        }
        ...
        public void HttpPublishedAssetsGetTest()
        {
            ...
            //Assert.IsInstanceOf(typeof(PublishEntity), response, "response is PublishEntity");
        }
        ...
        public void HttpPublishedAssetsGetByIdTest()
        {
            ...
            //Assert.IsInstanceOf(typeof(PublishedAsset), response, "response is PublishedAsset");
        }
