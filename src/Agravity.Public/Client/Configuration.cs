...
namespace Agravity.Public.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "10.1.4";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/10.1.4/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 10.1.4\n";
            report += "    SDK Package Version: 10.1.4\n";
