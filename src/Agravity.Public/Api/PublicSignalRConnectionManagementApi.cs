...
namespace Agravity.Public.Api
{
    ...
    public interface IPublicSignalRConnectionManagementApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SignalRConnectionInfo> HttpSignalRNegotiateAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        System.Threading.Tasks.Task<ApiResponse<SignalRConnectionInfo>> HttpSignalRNegotiateWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
    ...
    public partial class PublicSignalRConnectionManagementApi : IPublicSignalRConnectionManagementApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SignalRConnectionInfo</returns>
        public async System.Threading.Tasks.Task<SignalRConnectionInfo> HttpSignalRNegotiateAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SignalRConnectionInfo)</returns>
        public async System.Threading.Tasks.Task<Agravity.Public.Client.ApiResponse<SignalRConnectionInfo>> HttpSignalRNegotiateWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
