...
namespace Agravity.Public.Model
{
    ...
    public partial class SharedCollectionZipRequest : IEquatable<SharedCollectionZipRequest>, IValidatableObject
    {
        ...
        public SharedCollectionZipRequest(string id = default(string), string entityType = default(string), string url = default(string), string instanceId = default(string), string sharedcollId = default(string), DateTime validUntil = default(DateTime), string password = default(string), List<SharedAllowedFormat> allowedFormats = default(List<SharedAllowedFormat>), AgravityErrorResponse error = default(AgravityErrorResponse), string status = default(string), DateTime? createdDate = default(DateTime?), string createdBy = default(string), DateTime? modifiedDate = default(DateTime?), string modifiedBy = default(string), string pk = default(string), string etag = default(string))
        {
            this.Id = id;
