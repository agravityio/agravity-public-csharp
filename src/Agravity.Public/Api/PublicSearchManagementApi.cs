...
namespace Agravity.Public.Api
{
    ...
    public interface IPublicSearchManagementApiSync : IApiAccessor
    {
        ...
        /// <param name="broadness">Search Broadness: Can be 0, 1 or 2. (0 is the most exact search, 2 is the broadest search) (1, 2 is with AI) (optional)</param>
        /// <param name="relId">The ID of the relation which this search is limited to. (Only the assets in this relation are returend) (optional)</param>
        /// <param name="scopefilter">Colon separated key value filter for additional scopes. It applies the same conventions as for filter parameter. (optional)</param>
    ...
    public partial class PublicSearchManagementApi : IPublicSearchManagementApi
    {
        ...
        public Agravity.Public.Client.ApiResponse<SearchResult> HttpGlobalSearchWithHttpInfo(string s, int? limit = default, int? skip = default, string collectiontypeid = default, string collectionid = default, string mode = default, bool? expose = default, string filter = default, int? broadness = default, string relId = default, string scopefilter = default, string orderby = default, string ids = default, string portalId = default, bool? translations = default, string acceptLanguage = default, int operationIndex = 0)
        {
            ...
            if (broadness != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agravity.Public.Client.ClientUtils.ParameterToMultiMap("", "broadness", broadness));
            }
            if (relId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agravity.Public.Client.ClientUtils.ParameterToMultiMap("", "rel_id", relId));
            }
            if (scopefilter != null)
            {
                localVarRequestOptions.QueryParameters.Add(Agravity.Public.Client.ClientUtils.ParameterToMultiMap("", "scopefilter", scopefilter));
        ...
        public Agravity.Public.Client.ApiResponse<SearchAdminStatus> HttpSearchAdminGetStatusWithHttpInfo(string portalId = default, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "PublicSearchManagementApi.HttpSearchAdminGetStatus";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<SearchAdminStatus>("/searchadmin/status", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("HttpSearchAdminGetStatus", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public async System.Threading.Tasks.Task<Agravity.Public.Client.ApiResponse<SearchAdminStatus>> HttpSearchAdminGetStatusWithHttpInfoAsync(string portalId = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<SearchAdminStatus>("/searchadmin/status", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
