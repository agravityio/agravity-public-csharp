...
{
    /// <summary>
    ///  Class for testing PublicAIOperationsApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class PublicAIOperationsApiTests : IDisposable
    {
        private PublicAIOperationsApi instance;

        public PublicAIOperationsApiTests()
        {
            instance = new PublicAIOperationsApi();
        }
        ...
        /// <summary>
        /// Test an instance of PublicAIOperationsApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' PublicAIOperationsApi
            //Assert.IsType<PublicAIOperationsApi>(instance);
        }

        /// <summary>
        /// Test HttpReverseAssetSearch
        /// </summary>
        [Fact]
        public void HttpReverseAssetSearchTest()
        {
            ...
            //var response = instance.HttpReverseAssetSearch(acceptLanguage, name, collectionid, file, filename, previewof);
