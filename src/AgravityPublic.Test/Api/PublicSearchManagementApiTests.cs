...
namespace AgravityPublic.Test
{
    ...
    /// </remarks>
    public class PublicSearchManagementApiTests
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOf' PublicSearchManagementApi
            //Assert.IsInstanceOf(typeof(PublicSearchManagementApi), instance);
        }
        ...
        public void HttpGlobalSearchTest()
        {
            ...
            //string filter = null;
            //string orderby = null;
            //var response = instance.HttpGlobalSearch(s, limit, collectiontypeid, collectionid, mode, expose, filter, orderby);
            //Assert.IsInstanceOf(typeof(SearchResult), response, "response is SearchResult");
        }
