...
namespace Agravity.Public.Test.Api
{
    ...
    /// </remarks>
    public class PublicCollectionTypeManagementApiTests : IDisposable
    {
        private PublicCollectionTypeManagementApi instance;

        public PublicCollectionTypeManagementApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' PublicCollectionTypeManagementApi
            //Assert.IsType<PublicCollectionTypeManagementApi>(instance);
        }
