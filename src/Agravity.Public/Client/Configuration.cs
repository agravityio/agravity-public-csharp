...
namespace Agravity.Public.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "8.0.0-preview.1";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/8.0.0-preview.1/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 8.0.0-preview.1\n";
            report += "    SDK Package Version: 8.0.0-preview.1\n";
