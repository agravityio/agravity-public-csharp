...
namespace AgravityPublic.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = AgravityPublic.Client.Configuration.Default;
            RestClient = new RestClient("http://localhost:7072/api");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (http://localhost:7072/api).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? AgravityPublic.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "http://localhost:7072/api")
        {
