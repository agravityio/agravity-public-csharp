...
namespace Agravity.Public.Model
{
    ...
    /// </summary>
    [DataContract(Name = "collectionUDLListEntity")]
    public partial class CollectionUDLListEntity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CollectionUDLListEntity" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="entityType">entityType.</param>
        /// <param name="udlRefs">udlRefs.</param>
        /// <param name="udlEntries">udlEntries.</param>
        ...
        public CollectionUDLListEntity(string id = default, string entityType = default, List<CollectionUDLReference> udlRefs = default, List<CollectionUDL> udlEntries = default, string status = default, DateTime? createdDate = default, string createdBy = default, DateTime? modifiedDate = default, string modifiedBy = default, string pk = default, string etag = default)
        {
            this.Id = id;
            this.EntityType = entityType;
            this.UdlRefs = udlRefs;
            this.UdlEntries = udlEntries;
            this.Status = status;
        ...
        /// <summary>
        /// Gets or Sets UdlRefs
        /// </summary>
        [DataMember(Name = "udl_refs", EmitDefaultValue = true)]
        public List<CollectionUDLReference> UdlRefs { get; set; }

        /// <summary>
        /// Gets or Sets UdlEntries
        /// </summary>
        [DataMember(Name = "udl_entries", EmitDefaultValue = true)]
        public List<CollectionUDL> UdlEntries { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CollectionUDLListEntity {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EntityType: ").Append(EntityType).Append("\n");
            sb.Append("  UdlRefs: ").Append(UdlRefs).Append("\n");
            sb.Append("  UdlEntries: ").Append(UdlEntries).Append("\n");
