...
namespace Agravity.Public.Api
{
    ...
    /// </summary>
    public interface IPublicAssetRelationTypeManagementApiSync : IApiAccessor
    {
        ...
        /// <returns>List&lt;AssetRelationType&gt;</returns>
        List<AssetRelationType> HttpAssetRelationTypeGetAll(bool? translations = default, string acceptLanguage = default, int operationIndex = 0);
        ...
        /// <param name="acceptLanguage">The requested language of the response. If not matching it falls back to default language. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;AssetRelationType&gt;</returns>
        ApiResponse<List<AssetRelationType>> HttpAssetRelationTypeGetAllWithHttpInfo(bool? translations = default, string acceptLanguage = default, int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <exception cref="Agravity.Public.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The ID of the asset relation type.</param>
        /// <param name="translations">When default language should be returned and the translation dictionary is delivered. (Ignores the \&quot;Accept-Language\&quot; header) (optional)</param>
        /// <param name="acceptLanguage">The requested language of the response. If not matching it falls back to default language. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AssetRelationType</returns>
        AssetRelationType HttpAssetRelationTypeGetById(string id, bool? translations = default, string acceptLanguage = default, int operationIndex = 0);
        ...
        /// <param name="acceptLanguage">The requested language of the response. If not matching it falls back to default language. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AssetRelationType</returns>
        ApiResponse<AssetRelationType> HttpAssetRelationTypeGetByIdWithHttpInfo(string id, bool? translations = default, string acceptLanguage = default, int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IPublicAssetRelationTypeManagementApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of List&lt;AssetRelationType&gt;</returns>
        System.Threading.Tasks.Task<List<AssetRelationType>> HttpAssetRelationTypeGetAllAsync(bool? translations = default, string acceptLanguage = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;AssetRelationType&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<AssetRelationType>>> HttpAssetRelationTypeGetAllWithHttpInfoAsync(bool? translations = default, string acceptLanguage = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AssetRelationType</returns>
        System.Threading.Tasks.Task<AssetRelationType> HttpAssetRelationTypeGetByIdAsync(string id, bool? translations = default, string acceptLanguage = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AssetRelationType)</returns>
        System.Threading.Tasks.Task<ApiResponse<AssetRelationType>> HttpAssetRelationTypeGetByIdWithHttpInfoAsync(string id, bool? translations = default, string acceptLanguage = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IPublicAssetRelationTypeManagementApi : IPublicAssetRelationTypeManagementApiSync, IPublicAssetRelationTypeManagementApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class PublicAssetRelationTypeManagementApi : IPublicAssetRelationTypeManagementApi
    {
        private Agravity.Public.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="PublicAssetRelationTypeManagementApi"/> class.
        /// </summary>
        /// <returns></returns>
        public PublicAssetRelationTypeManagementApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public PublicAssetRelationTypeManagementApi(string basePath)
        {
        ...
        /// <returns></returns>
        public PublicAssetRelationTypeManagementApi(Agravity.Public.Client.Configuration configuration)
        {
        ...
        public PublicAssetRelationTypeManagementApi(Agravity.Public.Client.ISynchronousClient client, Agravity.Public.Client.IAsynchronousClient asyncClient, Agravity.Public.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;AssetRelationType&gt;</returns>
        public List<AssetRelationType> HttpAssetRelationTypeGetAll(bool? translations = default, string acceptLanguage = default, int operationIndex = 0)
        {
            Agravity.Public.Client.ApiResponse<List<AssetRelationType>> localVarResponse = HttpAssetRelationTypeGetAllWithHttpInfo(translations, acceptLanguage);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;AssetRelationType&gt;</returns>
        public Agravity.Public.Client.ApiResponse<List<AssetRelationType>> HttpAssetRelationTypeGetAllWithHttpInfo(bool? translations = default, string acceptLanguage = default, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "PublicAssetRelationTypeManagementApi.HttpAssetRelationTypeGetAll";
            ...
            var localVarResponse = this.Client.Get<List<AssetRelationType>>("/assetrelationtypes", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("HttpAssetRelationTypeGetAll", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;AssetRelationType&gt;</returns>
        public async System.Threading.Tasks.Task<List<AssetRelationType>> HttpAssetRelationTypeGetAllAsync(bool? translations = default, string acceptLanguage = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            Agravity.Public.Client.ApiResponse<List<AssetRelationType>> localVarResponse = await HttpAssetRelationTypeGetAllWithHttpInfoAsync(translations, acceptLanguage, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;AssetRelationType&gt;)</returns>
        public async System.Threading.Tasks.Task<Agravity.Public.Client.ApiResponse<List<AssetRelationType>>> HttpAssetRelationTypeGetAllWithHttpInfoAsync(bool? translations = default, string acceptLanguage = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<AssetRelationType>>("/assetrelationtypes", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AssetRelationType</returns>
        public AssetRelationType HttpAssetRelationTypeGetById(string id, bool? translations = default, string acceptLanguage = default, int operationIndex = 0)
        {
            Agravity.Public.Client.ApiResponse<AssetRelationType> localVarResponse = HttpAssetRelationTypeGetByIdWithHttpInfo(id, translations, acceptLanguage);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AssetRelationType</returns>
        public Agravity.Public.Client.ApiResponse<AssetRelationType> HttpAssetRelationTypeGetByIdWithHttpInfo(string id, bool? translations = default, string acceptLanguage = default, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Agravity.Public.Client.ApiException(400, "Missing required parameter 'id' when calling PublicAssetRelationTypeManagementApi->HttpAssetRelationTypeGetById");
            }
            ...
            localVarRequestOptions.Operation = "PublicAssetRelationTypeManagementApi.HttpAssetRelationTypeGetById";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<AssetRelationType>("/assetrelationtypes/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("HttpAssetRelationTypeGetById", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AssetRelationType</returns>
        public async System.Threading.Tasks.Task<AssetRelationType> HttpAssetRelationTypeGetByIdAsync(string id, bool? translations = default, string acceptLanguage = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            Agravity.Public.Client.ApiResponse<AssetRelationType> localVarResponse = await HttpAssetRelationTypeGetByIdWithHttpInfoAsync(id, translations, acceptLanguage, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AssetRelationType)</returns>
        public async System.Threading.Tasks.Task<Agravity.Public.Client.ApiResponse<AssetRelationType>> HttpAssetRelationTypeGetByIdWithHttpInfoAsync(string id, bool? translations = default, string acceptLanguage = default, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AssetRelationType>("/assetrelationtypes/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
