...
namespace Agravity.Public.Api
{
    ...
    public interface IPublicWorkspaceManagementApiSync : IApiAccessor
    {
        ...
        List<Workspace> HttpWorkspacesGet(int operationIndex = 0);
        ...
        ApiResponse<List<Workspace>> HttpWorkspacesGetWithHttpInfo(int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        Workspace HttpWorkspacesGetById(string id, int operationIndex = 0);
        ...
        ApiResponse<Workspace> HttpWorkspacesGetByIdWithHttpInfo(string id, int operationIndex = 0);
    ...
    public interface IPublicWorkspaceManagementApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<Workspace>> HttpWorkspacesGetAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Workspace>>> HttpWorkspacesGetWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Workspace> HttpWorkspacesGetByIdAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Workspace>> HttpWorkspacesGetByIdWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class PublicWorkspaceManagementApi : IPublicWorkspaceManagementApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;Workspace&gt;</returns>
        public List<Workspace> HttpWorkspacesGet(int operationIndex = 0)
        {
            Agravity.Public.Client.ApiResponse<List<Workspace>> localVarResponse = HttpWorkspacesGetWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;Workspace&gt;</returns>
        public Agravity.Public.Client.ApiResponse<List<Workspace>> HttpWorkspacesGetWithHttpInfo(int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;Workspace&gt;</returns>
        public async System.Threading.Tasks.Task<List<Workspace>> HttpWorkspacesGetAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Agravity.Public.Client.ApiResponse<List<Workspace>> localVarResponse = await HttpWorkspacesGetWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Workspace&gt;)</returns>
        public async System.Threading.Tasks.Task<Agravity.Public.Client.ApiResponse<List<Workspace>>> HttpWorkspacesGetWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Workspace</returns>
        public Workspace HttpWorkspacesGetById(string id, int operationIndex = 0)
        {
            Agravity.Public.Client.ApiResponse<Workspace> localVarResponse = HttpWorkspacesGetByIdWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Workspace</returns>
        public Agravity.Public.Client.ApiResponse<Workspace> HttpWorkspacesGetByIdWithHttpInfo(string id, int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Workspace</returns>
        public async System.Threading.Tasks.Task<Workspace> HttpWorkspacesGetByIdAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Agravity.Public.Client.ApiResponse<Workspace> localVarResponse = await HttpWorkspacesGetByIdWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Workspace)</returns>
        public async System.Threading.Tasks.Task<Agravity.Public.Client.ApiResponse<Workspace>> HttpWorkspacesGetByIdWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
