...
namespace Agravity.Public.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "5.0.1-RC1";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/5.0.1-RC1/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 5.0.1-RC1\n";
            report += "    SDK Package Version: 5.0.1-RC1\n";
